...
class CustomerReservationCancellationControllerTest {
    ...
    void shouldCancelBooking() throws Exception {
                when(customerReservationCancellationService.cancelOwnBooking("customer@test.local", 101L))
    ...
    void shouldRejectWhenRoleIsNotClient() throws Exception {
                when(customerReservationCancellationService.cancelOwnBooking("provider@test.local", 101L))
